...
export interface PokemonTypesInterface {
  ...
  attack: AttackDefenceInterface
  defence: AttackDefenceInterface
  [propName: string]: string | FC<SVGProps<SVGSVGElement>> | AttackDefenceInterface;

}
const strengthsWeaknesses: AttackDefenceInterface = {
...
export interface AttackDefenceInterface {
  [key: string]: number,
  water: number,
  steel: number,
  rock: number,
